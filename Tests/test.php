...
\EasySwoole\MysqliPool\Mysql::getInstance()->register('mysql',new \EasySwoole\Mysqli\Config());
...
//    $modelConfig->setBaseDirectory(EASYSWOOLE_ROOT . '/' . $automatic::APP_PATH . '/Model/Payment');
//    $modelConfig->setBaseNamespace("App\\Model\\Payment");
